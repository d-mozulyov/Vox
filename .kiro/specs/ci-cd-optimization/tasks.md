...
**Подзадачи**:
- [x] Создать `.github/workflows/docker-build.yml`
- [x] Настроить триггер (manual dispatch или изменение Dockerfile)
- [x] Добавить сборку и публикацию образа
- [x] Добавить тегирование версий образа

**Критерии приемки**:
- Workflow собирает и публикует образ автоматически ✓
- Можно запустить вручную через GitHub UI ✓
- Образ тегируется версией ✓
